...
import WireframeScreen from './components/list_screen/WireframeScreen.js';
        ...
        <BrowserRouter>
          <div className="App">
            ...
            <Switch>
              ...
              <Route path="/user/:id/wireframes" component={HomeScreen} />
              <Route path="/user/:id/wireframe/:id" component={WireframeScreen} />
